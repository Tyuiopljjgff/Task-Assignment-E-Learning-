<x-admin-layout>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form action="{{ route('admin.academic-levels.update', $academicLevel) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', $academicLevel->name_ar) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name_en" id="name_en" value="{{ old('name_en', $academicLevel->name_en) }}"
    ...
    @enderror
                ...
                <div class="mb-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $academicLevel->is_active) ? 'checked' : '' }}

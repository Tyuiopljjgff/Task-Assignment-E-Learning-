            ...
            <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="student_name_ar" id="student_name_ar" value="{{ old('student_name_ar', $testimonial->student_name_ar) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="student_name_en" id="student_name_en" value="{{ old('student_name_en', $testimonial->student_name_en) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="course_ar" id="course_ar" value="{{ old('course_ar', $testimonial->course_ar) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="course_en" id="course_en" value="{{ old('course_en', $testimonial->course_en) }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="text_ar" id="text_ar" rows="4"
                        ...
                        required dir="rtl">{{ old('text_ar', $testimonial->text_ar) }}</textarea>
                    @error('text_ar')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="text_en" id="text_en" rows="4"
                        ...
                        required>{{ old('text_en', $testimonial->text_en) }}</textarea>
                    @error('text_en')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <select name="color" id="color"
                            ...
                            <option value="green" {{ old('color', $testimonial->color) == 'green' ? 'selected' : '' }}>Green</option>
                            <option value="orange" {{ old('color', $testimonial->color) == 'orange' ? 'selected' : '' }}>Orange</option>
                    ...
                    <div class="mb-4">
                        ...
                        @if($testimonial->image)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $testimonial->image) }}" alt="{{ $testimonial->student_name_en }}" class="w-32 h-32 object-cover rounded">
                            </div>
                        @endif

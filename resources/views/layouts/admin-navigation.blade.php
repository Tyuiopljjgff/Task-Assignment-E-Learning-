<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.academic-levels.index')" :active="request()->routeIs('admin.academic-levels.*')">
                        {{ __('Academic Levels') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('admin.career-submissions.index')" :active="request()->routeIs('admin.career-submissions.*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.academic-levels.index')" :active="request()->routeIs('admin.academic-levels.*')">
                {{ __('Academic Levels') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('admin.career-submissions.index')" :active="request()->routeIs('admin.career-submissions.*')">
                {{ __('Career Submissions') }}
            </x-responsive-nav-link>
